...
// Portfolio data for carousel
        ...
        const portfolioData = [
            {
                id: 1,
                title: 'ZQOORT',
                description: 'Smart WhatsApp automation app with real-time messaging, smart replies, and advanced bot features.',
                image: 'images/neural-network.jpg',
                tech: ['Node.js', 'WebSockets', 'WhatsApp API'],
                link: 'https://drive.google.com/file/d/1MiIul0zIWARRwfz7c3iKHG5vSd5EjyPM/view'
            },
            {
                id: 2,
                title: 'E-Commerce',
                description: 'Modern fully responsive e-commerce website with clean UI, product listings, and smooth shopping experience.',
                image: 'images/quantum-cloud.jpg',
                tech: ['HTML', 'CSS', 'JavaScript'],
                link: 'https://ahmad-markiting-ddfd21.netlify.app/'
            },
            {
                id: 3,
                title: 'Weather App',
                description: 'Real-time weather dashboard with location-based forecasts, clean UI, and live API integration.',
                image: 'images/data-nexus.jpg',
                tech: ['JavaScript', 'REST API', 'CSS'],
                link: 'https://github.com/nassarahmad/WeatherAppUser'
            }
        ];
        ...
        const skillsData = [
            ...
            { name: 'HTML & CSS', icon: '🎨', level: 92, category: 'frontend' },
            { name: 'Node.js', icon: '🟢', level: 87, category: 'backend' },
            { name: 'Express.js', icon: '🚂', level: 85, category: 'backend' },
            { name: 'REST APIs', icon: '🔌', level: 88, category: 'backend' },
            { name: 'WebSockets', icon: '⚡', level: 82, category: 'backend' },
            { name: 'MongoDB', icon: '🍃', level: 85, category: 'database' },
            { name: 'SQL', icon: '🗄️', level: 78, category: 'database' },
